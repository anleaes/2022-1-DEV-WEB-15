...
# projeto "(RAIZ)nome_do_projeto_que_voce_escolher" conforme a seguir
...
# Inserir as informacoes a seguir e salvar.
...
# Crie uma pasta "apps" na raiz do projeto "(RAIZ)nome_do_projeto_que_voce_escolher"
...
# adicione a linha seguir para referenciar e adicionar o projeto para
# as pastas criadas onde ficarao os arquivos estaticos do projeto, tais
...
# Procurar por TEMPLATES e em seguida procure pelo campo DIR e adicione
